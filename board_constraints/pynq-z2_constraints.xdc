...
# PmodB
# 1: ASR-33
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { pwm_left }];
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { pwm_right }];
...
set_property -dict { PACKAGE_PIN V12 PULLUP true IOSTANDARD LVCMOS33 } [get_ports { PS2_CLOCK }];
set_property -dict { PACKAGE_PIN W13 PULLUP true IOSTANDARD LVCMOS33 } [get_ports { PS2_DATA }];
...
# Board LEDs
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {led_blue}];
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {led_button}];
...
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports clk_sys];
